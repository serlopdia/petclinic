...
class OwnerControllerTests {
	...
	void testProcessFindFormSuccess() throws Exception {
		...
		given(this.authoritiesService.getUserAuthority()).willReturn("admin");
	...
	void testProcessFindFormByLastName() throws Exception {
		...
		given(this.clinicService.findWhoEnters()).willReturn(george);
		given(this.authoritiesService.getUserAuthority()).willReturn("owner");
